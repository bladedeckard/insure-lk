...
<div class="flex gap-2"><button wire:click="save" class="bg-slate-900 text-white px-4 py-2 rounded">Сохранить</button><a href="{{ route('intermediaries.index') }}" class="px-4 py-2">Отмена</a></div>
</div>
</div>
