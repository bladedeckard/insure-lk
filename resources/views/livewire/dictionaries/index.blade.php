<div>
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Словари</h1>
            <p class="text-sm text-gray-500 mt-1">Универсальные справочники системы</p>
        </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm mb-6">
        <div class="p-4">
            <div class="relative max-w-sm">
                ...
                <input wire:model.live="search" placeholder="Поиск по коду или названию..."
        ...
        <table class="w-full">
            <thead>
                <tr class="border-b border-gray-100">
                    ...
                    <th class="text-center px-6 py-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Элементов</th>
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <tr class="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td class="px-6 py-4">
                        <a href="{{ route('dictionaries.edit', $d) }}" class="text-sm font-semibold text-gray-900 hover:text-primary-600 transition-colors">
                            {{ $d->name }}
                        </a>
                    </td>
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center justify-end gap-2">
                            <a href="{{ route('dictionaries.edit', $d) }}"
                            ...
                            <button onclick="confirmAction({
                                    ...
                                    message: 'Точно удалить словарь «{{ $d->name }}»? Все элементы будут удалены безвозвратно.',
                                    confirmText: 'Удалить',
                                    onConfirm: function() { @this.call('delete', {{ $d->id }}); }
                                })"
                ...
                <tr>
                    <td colspan="4" class="px-6 py-12 text-center">
                        <p class="text-sm text-gray-500">Словарей пока нет</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
    ...
    <div class="mt-4">{{ $dicts->links() }}</div>
</div>
