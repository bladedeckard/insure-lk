        ...
        <div class="p-6">
            <div class="flex justify-between items-center mb-6">
                <h3 class="text-xl font-semibold text-gray-800">
                    <?php echo e($editingCoverageIndex >= 0 ? 'Редактировать покрытие' : 'Новое покрытие'); ?>
            ...
            <div class="space-y-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cov_type === 'range'): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cov_type === 'constant'): ?>
                    <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cov_type === 'set'): ?>
                    <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cov_type === 'flag'): ?>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">
                            Описание
...
<?php /**PATH A:\XAMPP\htdocs\insure-lk\resources\views/livewire/products/modals/coverage-modal.blade.php ENDPATH**/ ?>